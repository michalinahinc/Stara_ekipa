...
```
W przypadku zmiennej "Gender", mamy 13 błędów, zmiennej "Married" mamy 3 błędy, zmiennej "Dependents" - 15 błędów, zmiennej "Self_Employed" - 32 błędy. Ponadto w przypadku zmiennej "LoanAmount" mamy 22 braków danych, zmiennej "Loan_Amount_Term" 14 braków danych, a w przypadku zmiennej "Credit_History" - 50 braków danych.

# To musimy sprawdzić, bo wcześniej nam wyszło 149 NA, a mi teraz nie wiem czmeu 86
