...
```
Wykres kołowy przedstawia zależność między statusem edukacyjnym a decyzją o przyznaniu kredytu. Absolwenci (Graduate) częściej otrzymują kredyt (71%) niż nieabsolwenci (61%). Różnica jest istotna statystycznie (p = 0.03), ale jej siła jest niewielka (V-Cramer = 0.08).
...
Yes (n = 401): Osoby zamężne/żonate
Średnia kwota kredytu dla grupy No: 128.85.
