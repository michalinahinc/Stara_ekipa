...
```{r}
#zmiana danych  z "chr" na factor

Education <- as.factor(pozyczki$Education)
...
# Użycie hotdeck() bez tworzenia dodatkowych kolumn
library(VIM)
dane_czyste <- VIM::hotdeck(pozyczki)


data_imputed <- hotdeck(pozyczki$Gender, imp_var = FALSE)
data_imputed <- hotdeck(pozyczki$Married, imp_var = FALSE)
...
#
#znalazlo nam KOLUMNY, w których brakuje danych
hotdeck(pozyczki$Gender)
print(pozyczki)
view(pozyczki)
...
>>>>>>> 01f30f73af917ae5e559f2fc3bc5ba3cc4b30e79
